...
if(isset($_POST['borrar'])) {
    ...
    header('Location: Pro_html_admin.html'); // Redirecciona a sí mismo para actualizar la página
    exit;
}
...
<div class="row">
    <div class="col-lg-4">
        ...
        <form action="Backend/subir_admin.php" method="post" enctype="multipart/form-data">
        ...
        <div class="card-columns">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="proyecto_admin.php" method="post">
